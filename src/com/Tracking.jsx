...
const spacing = async()=>{
  ...
  animate("#main",{backgroundColor : "#c9b926",width:["30px","80px"]},{
    duration: 1,
    delay: 0.3,
    repeat: Infinity,
    repeatType:"reverse",
...
useEffect(()=>{
  ...
  return (
    ...
    <h1 className="   font-bold text-[19rem] text-white " id="title">T</h1>
    <div id="main" className="w-[30px] h-[230px]  bg-gray-300" style={{transformOrigin: "left"}}></div>
    <h1 id="right" className="font-bold text-[19rem] text-white " id="title" >R</h1>
